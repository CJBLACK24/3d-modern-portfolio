  ...
  return (
    ...
    <div
      ...
      className={cn(
        ...
        "h-10 md:h-[4.5rem] bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-1500 relative flex flex-col items-center w-full justify-center overflow-hidden px-2 sm:px-4 md:px-6",
